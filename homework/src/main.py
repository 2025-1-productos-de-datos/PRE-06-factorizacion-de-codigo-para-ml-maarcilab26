...
# Para llamarlo: python3 homework/src/main.py --model elasticket --l_ratio 0.1 --alpha 1
# En este caso, la persona tiene que conocer la ruta dond está el archivo (homework/src/main.py) y eso no es bueno, hay que volver el código ejecutable
